...
//list: ratings and school
  ...
  $stmt = $pdo->prepare("SELECT * FROM `reviews` WHERE `school` = 'Queens University' AND `program` = 'Accounting' ORDER BY `id` DESC");
  $stmt->execute();
  ...
  <a class="accbtn" href="https://smith.queensu.ca/bcom/academics/fields_study/index.php">Program details</a>
