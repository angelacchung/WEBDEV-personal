...
//list: ratings and school
  ...
  $stmt = $pdo->prepare("SELECT * FROM `reviews` WHERE `school` = 'University of Toronto' AND `program` = 'Accounting' ORDER BY `id` DESC");
  $stmt->execute();
  ...
  <a class="accbtn" href="https://fas.calendar.utoronto.ca/section/Rotman-Commerce">Program details</a>
