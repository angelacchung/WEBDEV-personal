...
//list: ratings and school
  ...
  $stmt = $pdo->prepare("SELECT * FROM `reviews` WHERE `school` = 'McMaster University' AND `program` = 'Accounting' ORDER BY `id` DESC");
  $stmt->execute();
  ...
  <a class="accbtn" href="https://future.mcmaster.ca/programs/business/#Profiles">Program details</a>
