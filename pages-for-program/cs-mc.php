...
//list: ratings and school
  ...
  $stmt = $pdo->prepare("SELECT * FROM `reviews` WHERE `school` = 'McMaster University' AND `program` = 'Computer Science' ORDER BY `id` DESC");
  $stmt->execute();
  ...
  <a class="accbtn" href="https://www.eng.mcmaster.ca/computer-science-basc
">Program details</a>
