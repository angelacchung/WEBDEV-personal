...
//list: ratings and school
  ...
  $stmt = $pdo->prepare("SELECT * FROM `reviews` WHERE `school` = 'University of Toronto' AND `program` = 'English' ORDER BY `id` DESC");
  $stmt->execute();
  ...
  <a class="accbtn" href="https://futurestudents.yorku.ca/program/english">Program details</a>
