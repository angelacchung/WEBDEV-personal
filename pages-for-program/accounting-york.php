...
//list: ratings and school
  ...
  $stmt = $pdo->prepare("SELECT * FROM `reviews` WHERE `school` = 'York University' AND `program` = 'Accounting' ORDER BY `id` DESC");
  $stmt->execute();
  ...
  <a class="accbtn" href="http://sas.laps.yorku.ca/bas/specialized-honours-adms/">Program details</a>
